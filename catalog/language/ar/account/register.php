...
$_['text_agree']           = 'من خلال إنشاء الحساب وافق على<a href="%s" class="agree"><b>%s</b></a>  ماچلة';
$_['text_Sign_In']   = 'تسجيل الدخول';
$_['text_and']   = 'مع';
$_['button_continue1']   = 'الإستمرار';
// Entry
$_['entry_customer_group'] = 'مجموعة العميل';
$_['entry_firstname']      = 'الإسم الأول';
$_['entry_lastname']       = 'الإسم الاخير';
...
$_['entry_business']       = 'هل تريد التسجيل معنا كعميل أعمال
';


// Error
$_['error_exists']         = 'تحذير : البريد الالكتروني مسجل مسبقا!';
$_['error_firstname']      = 'الإسم الأول يجب أن يكون أكثر من 1 وأقل من 32 حرفا!';
$_['error_lastname']       = 'الإسم الاخير يجب أن يكون أكثر من 1 وأقل من 32 حرفا!';
