...
$_['text_manage_order']         = 'إدارة الطلب:';
$_['text_product_details']         = 'تفاصيل المنتج:';
$_['text_related_products']         = 'منتجات ذات صله:';
$_['text_view_all']		= 'الجميع';
$_['text_reorder']		= 'إعادة ترتيب';
$_['text_status_des']		= 'تمت الموافقة على منتجك';
$_['text_track']		= 'مسار';
$_['text_o_total']		= 'الطلب الكلي';
...
$_['txt_order_date']		= 'تاريخ';
$_['txt_order_contactus']	= 'اتصل بنا';
$_['txt_order_email']		= 'البريد الإلكتروني الفاتورة';
$_['txt_order_print']		= 'طلب طباعة';
