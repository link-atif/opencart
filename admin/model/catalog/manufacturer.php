...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "locations SET name = '" . $this->db->escape($data['name']) . "',adress = '" . $this->db->escape($data['adress']) . "',
		phone = '" . $this->db->escape($data['phone']) . "',lattitude = '" . $this->db->escape($data['lattitude']) . "',longitude = '" . $this->db->escape($data['longitude']) . "'");
	...
	public function editLocations($manufacturer_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "locations SET name = '" . $this->db->escape($data['name']) . "',adress = '" . $this->db->escape($data['adress']) . "',
		phone = '" . $this->db->escape($data['phone']) . "',lattitude = '" . $this->db->escape($data['lattitude']) . "',longitude = '" . $this->db->escape($data['longitude']) . "' WHERE id = '" . (int)$manufacturer_id . "'");
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
	...
	public function deleteLocation($manufacturer_id) {
		$this->db->query("DELETE FROM `" . DB_PREFIX . "locations` WHERE id = '" . (int)$manufacturer_id . "'");
