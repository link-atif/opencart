...
class ControllerCatalogProduct extends Controller {
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['gender']) < 3) || (utf8_strlen($this->request->post['gender']) > 64)) {
			$this->error['gender'] = $this->language->get('error_gender');
		}
		if ((utf8_strlen($this->request->post['size']) < 1) || (utf8_strlen($this->request->post['size']) > 64)) {
