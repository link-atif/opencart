...
class ControllerSettingStore extends Controller {
	...
	protected function getForm() {
		...
		} elseif (isset($store_info['config_fb'])) {
			$data['config_fb'] = $store_info['config_fb'];
		} else {
			$data['config_fb'] = '';
		}
		if (isset($this->request->post['config_inst'])) {
			$data['config_inst'] = $this->request->post['config_inst'];
		} elseif (isset($store_info['config_inst'])) {
			$data['config_inst'] = $store_info['config_inst'];
		} else {
			$data['config_inst'] = '';
		}
		if (isset($this->request->post['config_lin'])) {
			$data['config_lin'] = $this->request->post['config_lin'];
		} elseif (isset($store_info['config_lin'])) {
			$data['config_lin'] = $store_info['config_lin'];
		} else {
			$data['config_lin'] = '';
		}
		if (isset($this->request->post['config_twi'])) {
			$data['config_twi'] = $this->request->post['config_twi'];
		} elseif (isset($store_info['config_twi'])) {
			$data['config_twi'] = $store_info['config_twi'];
		} else {
			$data['config_twi'] = '';
		}
		if (isset($this->request->post['config_snap'])) {
			$data['config_snap'] = $this->request->post['config_snap'];
		} elseif (isset($store_info['config_snap'])) {
			$data['config_snap'] = $store_info['config_snap'];
		} else {
			$data['config_snap'] = '';
		}
